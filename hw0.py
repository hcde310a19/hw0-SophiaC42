...
#
# YEP Step 1: To run this program, in a terminal window, type:
#
...
# YEP Step 2: Now try deleting the second hello(). Save the file.
# Run the program again to see the results- Erased the repeat

# GOTCHA Step 3: Now insert "hello()" back into the editor buffer
...
# Save the file. Run it again to see the results.- The second hello paragraph came back!

# YEP Step 4: Now, try a Python program that uses variables. Uncomment
